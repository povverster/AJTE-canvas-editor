...
(function(global, factory) {
    ...
    AJTEBar.prototype.getTextContent = function(args){
        ...
        return '<li> \
            <div class="ajte-picker-wrap"> \
                <input id="ajte-color1" type="hidden" name="fill" value="' + args.fill + '" /> \
        ...
        <li> \
            <div class="ajte-font-size-wrap"> \
                ...
                <input name="fontSize" class="ajte-font-size" type="number" size="20" value="' + args.fontSize + '" /> \
            </div> \
        </li> \
        <li> \
            <div class="ajte-font-size-wrap"> \
                <i class="fa fa-arrows-alt-v"></i> \
                <input name="lineHeight" class="ajte-font-size" type="number" size="20" step="0.1" value="' + args.lineHeight + '" /> \
            </div> \
        </li> \
        <li> \
            <div class="ajte-font-family-wrap"> \
                <i class="fa fa-font"></i> \
                <select id="fontFamily" name="fontFamily"> ' + fontFamilyOptions + '</select>   \
            </div> \
        </li> \
        <li> \
        ...
        <li> \
            <div class="ajte-font-style-wrap"> \
                <input type="hidden" name="isBold" value="' + args.isBold + '"/> \
        ...
        <li> \
            <div class="ajte-font-style-wrap"> \
                <input type="hidden" name="isItalic" value="' + args.isItalic + '"/> \
                <div class="ajte-choose"> \
        ...
        <li> \
            <div class="ajte-font-style-wrap"> \
                <input type="hidden" name="isUnderline" value="' + args.isUnderline + '"/> \
                <div class="ajte-choose"> \
        ...
        <li> \
            <div class="ajte-padding-wrap"> \
                ...
                <input name="paddingTop" class="ajte-padding" type="text" size="5" value="' + args.paddingTop + '" /> \
                <i class="fa fa-arrow-right"></i> \
                <input name="paddingRight" class="ajte-padding" type="text" size="5" value="' + args.paddingRight + '" /> \
                <i class="fa fa-arrow-down"></i> \
                <input name="paddingBottom" class="ajte-padding" type="text" size="5" value="' + args.paddingBottom + '" /> \
                <i class="fa fa-arrow-left"></i> \
                <input name="paddingLeft" class="ajte-padding" type="text" size="5" value="' + args.paddingLeft + '" /> \
            </div> \
        </li>';
    ...
    AJTEBar.prototype.getShapeContent = function(args, type){
        ...
        var str = '<li> \
                <div class="ajte-picker-wrap"> \
                    <span>Fill:</span>   \
                    <input id="ajte-color2" type="hidden" name="fill" value="' + args.fill + '" /> \
            ...
            <li> \
                <div class="ajte-picker-wrap"> \
                    <span>Stroke:</span>   \
                    <input id="ajte-color3" type="hidden" name="stroke" value="' + args.stroke + '" /> \
            ...
            <li> \
                <div class="ajte-stroke-width-wrap"> \
                    ...
                    <input name="strokeWidth" class="ajte-font-size" type="number" size="20" value="' + args.strokeWidth + '" /> \
                </div> \
            </li>';
            ...
            if(type == 'rect'){
                str += '<li> \
                    <div class="ajte-corner-radius-width-wrap"> \
                        ...
                        <i class="fa fa-arrow-up"></i> \
                        <input name="borderRadiusTop" class="ajte-padding" type="text" size="5" value="' + args.borderRadiusTop + '" /> \
                        <i class="fa fa-arrow-right"></i> \
                        <input name="borderRadiusRight" class="ajte-padding" type="text" size="5" value="' + args.borderRadiusRight + '" /> \
                        <i class="fa fa-arrow-down"></i> \
                        <input name="borderRadiusBottom" class="ajte-padding" type="text" size="5" value="' + args.borderRadiusBottom + '" /> \
                        <i class="fa fa-arrow-left"></i> \
                        <input name="borderRadiusLeft" class="ajte-padding" type="text" size="5" value="' + args.borderRadiusLeft + '" /> \
                    </div> \
                </li>';
            }
        return str;
    ...
    AJTEBar.prototype.addBody = function(){
        ...
        var htmldata = '<div class="ajte-row ajte-barline-border"> \
                    <div class="ajte-container ajte-barcontainer"> \
                        ...
                        <div class="ajte-middleside"> \
                            <div class="ajte-stage-size"> \
                                <span>X:</span>  \
                                <input type="number" name="stageWidth" class="ajte-stage" value="' + this.args.stage.width + '" maxlength="4">    \
                                <span>Y:</span>  \
                                <input type="number" name="stageHeight" class="ajte-stage" value="' + this.args.stage.height + '" maxlength="4">    \
                            </div>  \
                        </div> \
    ...
    AJTEBar.prototype.addToolbar = function(){
        if(ajteMode == "dev"){
        ...
        var actionElementItems = document.querySelectorAll('#ajtebar a[data-element-action]');
        ...
        var ajteStageInputsNumber = document.querySelectorAll("#ajtebar input[type=number].ajte-stage");
        ...
        document.getElementById("ajteImage").addEventListener('click', function(){
            self.cb.image_cb();
        });
    }
    ...
    AJTEBar.prototype.activateToolbarContent = function(self){
        ...
        for(var i = 1; i <= 3; i++){
            if(document.getElementById('ajte-picker' + i)){
                var input = document.getElementById('ajte-picker' + i).previousElementSibling;
        ...
        for (var i = 0; i < switchers.length; i++) {
            ...
            new AJTESwitcher(switchers[i], input, self.settings.AJTEEditor.changeElementStyle.bind(self.settings.AJTEEditor) );
        }
        ...
        for(var i = 0; i < ajteChooses.length; i++ ){
            ...
            new AJTEChoose(ajteChooses[i], input, self.settings.AJTEEditor.changeElementStyle.bind(self.settings.AJTEEditor) );
        }
        ...
        var ajteInputsNumber = document.querySelectorAll("#ajtebar input[type=number]:not(.ajte-stage)");
    ...
    AJTEElement.prototype.initInactiveElement = function(){
        ...
        if(this instanceof AJTEImage){
            ...
            self.el.on('transformend', function () {
                self.lastTimeTranformed = new Date();
                setTimeout(function(){
    ...
    AJTEElement.prototype.addToHistoryAfterTransform = function(self){
        ...
        if((currentDate - self.lastTimeTranformed) > 100){
    ...
    AJTEElement.prototype.elOnDrag = function(el){
        // if(ajteMode == "dev"){
        //     console.info("AJTEElement:elOnDrag");
        // }
    ...
    AJTEElement.prototype.elOnDrop = function(el){
        // if(ajteMode == "dev"){
        //     console.info("AJTEElement:elOnDrop");
        // }
    ...
    AJTEElement.prototype.generateArrStyle = function(stylename, direction, styleval){
        if(ajteMode == "dev"){
    ...
    function AJTEText(args, AJTEEditor){
        ...
        this.width = args && args.width ? args.width : this.text.length * this.fontSize;
    ...
    AJTEText.prototype.editText = function(){
        ...
        textarea.addEventListener('keydown', function (e) {
            scale = self.el.getAbsoluteScale().x;
    ...
    AJTEText.prototype.adjustShape = function(){
        ...
        var width = this.el.attrs.width + this.el.attrs.paddingLeft + this.el.attrs.paddingRight;
        var height = this.el.getClientRect().height + this.el.attrs.paddingTop + this.el.attrs.paddingBottom;
    ...
    function AJTERect(args, AJTEEditor){
        ...
        this.strokeWidth  = args && args.strokeWidth !== undefined ? args.strokeWidth : 4;
        this.x = args && args.x ? args.x : 0;
        this.y = args && args.y ? args.y: 0;
        this.width = args && args.width ? args.width : 100;
        this.height = args && args.height ? args.height: 50;
        this.borderRadiusTop = args && args.borderRadiusTop ? args.borderRadiusTop : 0;
        this.borderRadiusRight = args && args.borderRadiusRight ? args.borderRadiusRight : 0;
        this.borderRadiusBottom = args && args.borderRadiusBottom ? args.borderRadiusBottom : 0;
        this.borderRadiusLeft = args && args.borderRadiusLeft ? args.borderRadiusLeft : 0;
        this.type = 'rect';
        ...
        this.init = function(){
            ...
            this.el = new Konva.Rect({
                ...
                cornerRadius: [self.borderRadiusTop, self.borderRadiusRight, self.borderRadiusBottom, self.borderRadiusLeft],
    ...
    function AJTELine(args, AJTEEditor){
        ...
        this.strokeWidth  = args && args.strokeWidth ? args.strokeWidth: 4;
        this.radius = args && args.radius ? args.radius : 100;
        this.points = args.line && args.line.points ? args.line.points : [0, 0, 100, 0],
        this.lineJoin = args.line && args.line.lineJoin ? args.line.lineJoin : 'round';
    ...
    function AJTEEditor(args){
        ...
        this.args = {
            ...
            image: {
                src: args.image && args.image.src ? args.image.src : 'no_image_available.png'
            },
            text: {
                fill: args.font && args.font.fill ? args.font.fill : '#42445A',
                fontSize: args.font && args.font.fontSize ? args.font.fontSize : 14,
                lineHeight: args.font && args.font.lineHeight ? args.font.lineHeight : 1.2,
                paddingTop: args.font && args.font.paddingTop ? args.font.paddingTop : 5,
                paddingRight: args.font && args.font.paddingRight ? args.font.paddingRight : 5,
                paddingBottom: args.font && args.font.paddingBottom ? args.font.paddingBottom : 5,
                paddingLeft: args.font && args.font.paddingLeft ? args.font.paddingLeft : 5,
                fontFamily: args.fontFamily && args.font.fontFamily ? args.font.fontFamily : 'Verdana',
                isItalic: false,
                isBold: false,
                isUnderline: false
            },
            ...
            shape: {
                strokeWidth: args.shape && args.shape.strokeWidth ? args.shape.strokeWidth : 4,
            ...
            rect: {
                ...
                borderRadiusTop: args.rect && args.rect.borderRadiusTop ? args.rect.borderRadiusTop : 0,
                borderRadiusRight: args.rect && args.rect.borderRadiusRight ? args.rect.borderRadiusRight : 0,
                borderRadiusBottom: args.rect && args.rect.borderRadiusBottom ? args.rect.borderRadiusBottom : 0,
                borderRadiusLeft: args.rect && args.rect.borderRadiusLeft ? args.rect.borderRadiusLeft : 0
            },
            circle: {
                radius: args.circle && args.circle.radius ? args.circle.radius :  70
            },
            ellipse: {
                radiusX: args.ellipse && args.ellipse.radiusX ? args.ellipse.radiusX : 100,
                radiusY: args.ellipse && args.ellipse.radiusY ? args.ellipse.radiusY: 50
            },
            line: {
                points: args.line && args.line.points ? args.line.points : [0, 0, 100, 0],
        ...
        this.containerOffset = args.containerOffset ? args.containerOffset : {x : 0, y : 0};
        this.currentElId = 0;
        ...
        this.init = function(){
            ...
            document.addEventListener("libraryActiveFileChanged", function(event) {
                if(self.store.elements[self.currentElId] && self.store.elements[self.currentElId] instanceof AJTEImage){
            ...
            document.addEventListener('keydown', function(event){
                if(event.code === "Delete" || event.code === 46) {
            ...
            if(args.code) {
                this.store = JSON.parse(args.code);
    ...
    AJTEEditor.prototype.setUpContextMenu = function(){
        ...
        self.stage.on('contextmenu', function (e) {
            ...
            var top = containerRect.top + self.stage.getPointerPosition().y + 4 + 'px';
            var left = containerRect.left + self.stage.getPointerPosition().x + 4 + 'px';
    ...
    AJTEEditor.prototype.chooseElement = function(id){
        ...
        if(this.bar){
            ...
            this.bar.setToolbarContent(this.bar, this.store.elements[id].type, el.attrs);
        }
    }
    ...
    AJTEEditor.prototype.createElement = function(args, type){
        ...
        var self = this;
        if(!args) args = {};
        if(args.index == undefined) args.index = Object.keys(this.store.elements).length;
    ...
    AJTEEditor.prototype.draw = function(store){
        ...
        this.args.stage.width = store.stage && store.stage.width ? store.stage.width : this.args.stage.width;
        this.args.stage.height = store.stage && store.stage.height ? store.stage.height : this.args.stage.height;
        this.setKonvaPlaceholder();
    }
    ...
    AJTEEditor.prototype.sendToServer = function(storejson, status, type, cb){
        ...
        xhr.upload.addEventListener("progress", function(event){self.__progressHandler(event, self, type)}, false);
        xhr.addEventListener("load", function(event){self.__completeHandler(event, self, type, cb)}, false);
        xhr.addEventListener("error", function(event){self.__errorHandler(event, self, type)}, false);
        xhr.addEventListener("abort", function(event){self.__abortHandler(event, self, type)}, false);
    ...
    AJTEEditor.prototype.__progressHandler = function(event, self, type){
        if(document.getElementById("AJTEprogressBar") && type == "visible"){
            ...
            document.getElementById("AJTEstatus").innerHTML = Math.round(percent) + '%';
        }
    }
    ...
    AJTEEditor.prototype.activateElement = function(instance, type){
        ...
        var inputTypes = ['text', 'editableText', 'image', 'rect', 'ellipse', 'line'];
        var el = instance.el;
        var id = el.attrs.id;
        var self = this;
    ...
    AJTEEditor.prototype.addInput = function(type, id){
        ...
        el.innerHTML = '<label>Enter label for your ' + type + ':</label> \
            <input type="text" id="input_' + id + '" name="' + id + '" class="ajte-input" value="' + this.store.elements[id].label + '"/>';
    ...
    AJTEEditor.prototype.addBody = function(){
        ...
        var htmldata = '<section id="ajteditor"> \
        ...
        if(this instanceof AJTEAdminEditor) {
            htmldata += '<div id="ajte-context-menu"> \
                <div> \
    ...
    AJTEEditor.prototype.addAsideBody = function(){
        ...
        tit.innerHTML = '<label>Title:</label> \
            <input type="text" id="arttitle" name="arttitle" class="ajte-input" value="' + this.title + '"/>';
        ...
        category.innerHTML = '<label>Category:</label> \
            <input type="text" id="artcategory" name="artcategory" class="ajte-input" value="' + this.category + '"/>';
        ...
        btns.innerHTML = '<ul class="aside-btn-wrap"> \
    ...
    AJTEEditor.prototype.activateAside = function(){
        ...
        var self = this;
        var actionItems = document.querySelectorAll('#ajteasidebuttons a[data-action]');
        for(var i = 0; i < actionItems.length; i++){
            actionItems[i].addEventListener('click', function(){
                self.menuAction(self, this);
                return false;
    ...
    AJTEUserEditor.prototype.addAsideCustomFields = function(){
        ...
        for(var i in this.customFields){
            ...
            var el = document.createElement('div');
            el.className = "ajte-input-wrap";
            var content = '<label for="' + field.name + '">' + field.label + '</label> \
                <textarea id="input_' + field.name + '" name="' + field.name + '" class="ajte-input"';
    ...
    AJTEUserEditor.prototype.addInput = function(type, id){
        ...
        var el = document.createElement('div');
        el.className = "ajte-input-wrap";
        el.innerHTML = '<label>' + this.store.elements[id].label + ':</label> \
            <textarea id="input_' + id + '" name="' + id + '" class="ajte-input">' + this.store.elements[id].value + '</textarea>';
